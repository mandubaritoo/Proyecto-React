    ...
    <section className="hero" id="inicio">
      <div className="contenedor hero-contenido">
        <div className="hero-texto">
          <p className="etiqueta">{saludo}, soy estudiante de Analista Programador</p>
          ...
          <a href="#proyecto" className="boton">Ver proyecto</a>
        </div>

        <div className="hero-imagen">
          <div className="hero-placeholder">
            <span>Vista principal del proyecto</span>
          </div>
        </div>
      </div>
    </section>
